...
style:
  ...
  hover:
    ...
    shadow: true  # Option values: true | false
    # Scale effect when the mouse hovers.
    scale: true   # Option values: true | false
...
social_contact:
  ...
  links:
    ...
    github:  https://github.com/Wster11        # GitHub
    weixin: img | ./images/weixin.jpeg      # WeChat
    qq:              # QQ
    weibo:           # WeiBo
    zhihu:           # ZhiHu
    twitter:         # Twitter
    facebook:        # Facebook
    email: 464905943@qq.com         # Email
